...
namespace Zeef {
    ...
    public static class GameObjectExtensions {
        ...
        public static T GetComponentWithError<T> (this GameObject gameObject) where T : Component {
            ...
            if (result == null) throw new MissingComponentException($"Could not find a {typeof(T)} component attached to {gameObject.name}");
            return result;
        }
        ...
        public static T GetComponentInChildrenWithError<T> (this GameObject gameObject) where T : Component {
            ...
            if (result == null) throw new MissingComponentException($"Could not find a {typeof(T)} component attached to {gameObject.name} or any of it's children");
            return result;
        }
        ...
        public static T GetComponentInParentWithError<T> (this GameObject gameObject) where T : Component {
            ...
            if (result == null) throw new MissingComponentException($"Could not find {typeof(T)} component.");
            return result;
        }
    }
}