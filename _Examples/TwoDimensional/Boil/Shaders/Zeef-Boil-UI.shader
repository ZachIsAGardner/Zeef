// Custom changes to originl shader.
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float2 offset = float2(
                    tex2D( _NoiseTex, float2(IN.worldPosition.y / _DistortionSpreader, (_Time[1] * _Speed))).r,
                    tex2D( _NoiseTex, float2((_Time[1] * _Speed), IN.worldPosition.x / _DistortionSpreader)).r
                );
